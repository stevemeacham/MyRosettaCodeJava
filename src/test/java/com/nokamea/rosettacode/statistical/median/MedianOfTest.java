...
class MedianOfTest {
    ...
    void integers() {
        ...
        for (int a = -5; a <= 5; a++) {
            ...
            for (int b = -5; b <= 5; b++) {
                assertEquals((a + b) / 2, MedianOf.integers(List.of(a, b)));

                for (int c = -5; c <=5; c++) {
                    final List<Integer> listOf3 = List.of(a, b, c);
                    final int medianOf3 = listOf3.stream().sorted().toList().get(1);
                    assertEquals(medianOf3, MedianOf.integers(listOf3));
    ...
    void integersAsFloat() {
        ...
        for (int a = -5; a <= 5; a++) {
            ...
            for (int b = -5; b <= 5; b++) {
                assertEquals((a + b) / 2f, MedianOf.integersAsFloat(List.of(a, b)));

                for (int c = -5; c <=5; c++) {
                    final List<Integer> listOf3 = List.of(a, b, c);
                    final Float medianOf3 = listOf3.stream().sorted().toList().get(1).floatValue();
                    assertEquals(medianOf3, MedianOf.integersAsFloat(listOf3));

                    for (int d = -5; d <=5; d++) {
                        final List<Integer> listOf4 = List.of(a, b, c, d);
                        final List<Integer> sortedListOf4 = listOf4.stream().sorted().toList();
                        final float medianOf4 = (sortedListOf4.get(1) + sortedListOf4.get(2)) / 2f;
                        assertEquals(medianOf4, MedianOf.integersAsFloat(listOf4));

                        for (int e = -5; e <= 5; e++) {
                            final List<Integer> listOf5 = List.of(a, b, c, d, e);
                            final float medianOf5 = listOf5.stream().sorted().toList().get(2);
                            assertEquals(medianOf5, MedianOf.integersAsFloat(listOf5));
                        }
                    }
                }
            }
    ...
    void integersAsDouble() {
        ...
        for (int a = -5; a <= 5; a++) {
            ...
            for (int b = -5; b <= 5; b++) {
                assertEquals((a + b) / 2d, MedianOf.integersAsDouble(List.of(a, b)));

                for (int c = -5; c <=5; c++) {
                    final List<Integer> listOf3 = List.of(a, b, c);
                    final Double medianOf3 = listOf3.stream().sorted().toList().get(1).doubleValue();
                    assertEquals(medianOf3, MedianOf.integersAsDouble(listOf3));

                    for (int d = -5; d <=5; d++) {
                        final List<Integer> listOf4 = List.of(a, b, c, d);
                        final List<Integer> sortedListOf4 = listOf4.stream().sorted().toList();
                        final double medianOf4 = (sortedListOf4.get(1) + sortedListOf4.get(2)) / 2d;
                        assertEquals(medianOf4, MedianOf.integersAsDouble(listOf4));

                        for (int e = -5; e <= 5; e++) {
                            final List<Integer> listOf5 = List.of(a, b, c, d, e);
                            final double medianOf5 = listOf5.stream().sorted().toList().get(2);
                            assertEquals(medianOf5, MedianOf.integersAsDouble(listOf5));
                        }
                    }
                }
            }
            ...
            for (float b = -5; b <= 5; b += 0.4f) {
                ...
                for (float c = -5; c <=5; c += 0.4f) {
                    ...
                    for (float d = -5; d <=5; d += 0.4f) {
                        ...
                        assertEquals(medianOf4, MedianOf.floats(listOf4));

                        for (float e = -5; e <= 5; e += 0.4f) {
                            final List<Float> listOf5 = List.of(a, b, c, d, e);
                            final float medianOf5 = listOf5.stream().sorted().toList().get(2);
                            assertEquals(medianOf5, MedianOf.floats(listOf5));
                        }
                    }
                }
            }
    ...
    void doubles() {
        ...
        for (double a = -5; a <= 5; a += 0.4d) {
            ...
            for (double b = -5; b <= 5; b += 0.4d) {
                assertEquals((a + b) / 2, MedianOf.doubles(List.of(a, b)));
                ...
                for (double c = -5; c <=5; c += 0.4d) {
                    ...
                    assertEquals(medianOf3, MedianOf.doubles(listOf3));
                    ...
                    for (double d = -5; d <=5; d += 0.4d) {
                        ...
                        assertEquals(medianOf4, MedianOf.doubles(listOf4));

                        for (double e = -5; e <= 5; e += 0.4d) {
                            final List<Double> listOf5 = List.of(a, b, c, d, e);
                            final double medianOf5 = listOf5.stream().sorted().toList().get(2);
                            assertEquals(medianOf5, MedianOf.doubles(listOf5));
                        }
                    }
                }
            }
    ...
    void bigIntegers() {
        ...
        for (BigInteger a = BigInteger.valueOf(-5); a.compareTo(BigInteger.valueOf(5)) <= 0; a = a.add(BigInteger.ONE)) {
            ...
            for (BigInteger b = BigInteger.valueOf(-5); b.compareTo(BigInteger.valueOf(5)) <= 0; b = b.add(BigInteger.ONE)) {
                assertEquals(a.add(b).divide(BigInteger.TWO).intValue(), MedianOf.bigIntegers(List.of(a, b)).intValue());
                ...
                for (BigInteger c = BigInteger.valueOf(-5); c.compareTo(BigInteger.valueOf(5)) <= 0; c = c.add(BigInteger.ONE)) {
                    ...
                    assertEquals(medianOf3.intValue(), MedianOf.bigIntegers(listOf3).intValue());
                    ...
                    for (BigInteger d = BigInteger.valueOf(-5); d.compareTo(BigInteger.valueOf(5)) <= 0; d = d.add(BigInteger.ONE)) {
                        ...
                        assertEquals(medianOf4.intValue(), MedianOf.bigIntegers(listOf4).intValue());
                        ...
                        for (BigInteger e = BigInteger.valueOf(-5); e.compareTo(BigInteger.valueOf(5)) <= 0; e = e.add(BigInteger.ONE)) {
                            ...
                            assertEquals(medianOf5.intValue(), MedianOf.bigIntegers(listOf5).intValue());
                        }
                    }
                }
            }
    ...
    void bigIntegersAsBigDecimal() {
        ...
        for (int aa = -5; aa <= 5; aa++) {
            ...
            final int aComparison = BigDecimal.valueOf(aa).compareTo(MedianOf.bigIntegersAsBigDecimal(List.of(a)));
            assertEquals(0, aComparison);

            for (int bb = -5; bb <= 5; bb++) {
                final BigInteger b = BigInteger.valueOf(bb);
                final int bComparison = (BigDecimal.valueOf(aa + bb).divide(BigDecimal.valueOf(2), RoundingMode.FLOOR)).compareTo(MedianOf.bigIntegersAsBigDecimal(List.of(a, b)));
                ...
                for (int cc = -5; cc <= 5; cc++) {
                    ...
                    final int cComparison = medianOf3.compareTo(MedianOf.bigIntegersAsBigDecimal(listOf3));
                    ...
                    for (int dd = -5; dd <= 5; dd++) {
                        ...
                        final int dComparison = medianOf4.compareTo(MedianOf.bigIntegersAsBigDecimal(listOf4));
                        ...
                        for (int ee = -5; ee <= 5; ee++) {
                            ...
                            final int eComparison = medianOf5.compareTo(MedianOf.bigIntegersAsBigDecimal(listOf5));
    ...
    void bigDecimals() {
        ...
        for (float a = -5; a <= 5; a += 0.4d) {
            ...
            assertEquals(ba, MedianOf.bigDecimals(List.of(ba)));

            for (float b = -5; b <= 5; b += 0.4d) {
                final BigDecimal bb = BigDecimal.valueOf(b);
                assertEquals(ba.add(bb).divide(BigDecimal.valueOf(2), RoundingMode.FLOOR).doubleValue(), MedianOf.bigDecimals(List.of(ba, bb)).doubleValue());
                ...
                for (float c = -5; c <= 5; c += 0.4d) {
                    ...
                    assertEquals(medianOf3.doubleValue(), MedianOf.bigDecimals(listOf3).doubleValue());
                    ...
                    for (float d = -5; d <= 5; d += 0.4d) {
                        ...
                        assertEquals(medianOf4, MedianOf.bigDecimals(listOf4));
